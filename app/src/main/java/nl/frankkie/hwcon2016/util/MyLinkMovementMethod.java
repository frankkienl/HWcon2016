...
public class MyLinkMovementMethod extends LinkMovementMethod {
    ...
    public void openLink(String link){
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            builder.setToolbarColor(activity.getResources().getColor(R.color.actionbar_background, null));
        } else {
            builder.setToolbarColor(activity.getResources().getColor(R.color.actionbar_background));
        }
        builder.build().launchUrl(activity, Uri.parse(link));
    }
        ...
        switch (what) {
            case CLICK:
                ...
                if (link[0] instanceof URLSpan) {
                    //Open links with Chrome Custom Tab
                    openLink(((URLSpan)link[0]).getURL());
                } else {
    ...
    public static MovementMethod getInstance(Activity activity) {
        if (sInstance == null)
            sInstance = new MyLinkMovementMethod(activity);
